        ...
        <div class="card-table">
            <div class="card-header">
                <div class="row w-full">
                    <div class="col">
                        <h3 class="card-title mb-0">Footer menu</h3>
                        <p class="text-secondary m-0">Footer mega menu.</p>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-actions justify-content-end">
                                            ...
                                            <a href="{{ route('ux.footer.del', ['id' => $b->id]) }}" class="btn btn-action"
                                                aria-label="Edit">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('ux.footer.post') }}" method="POST">
                        @csrf
