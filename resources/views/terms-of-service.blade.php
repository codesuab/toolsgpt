...
@section('content')
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <ol class="inline-flex items-center space-x-1.5 md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1.5 md:ml-2 text-slate-500 font-semibold">Terms of Service</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <!-- Content Header -->
        <h1 class="text-3xl sm:text-4xl font-space font-extrabold text-slate-900 mb-2">Terms of Service</h1>
